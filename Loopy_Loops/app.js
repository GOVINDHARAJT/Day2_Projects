...
for (let j = 0; j < len1; j++) {
    if (Prograd_1[j] == 'a' || Prograd_1 == 'A') {
        a++;
    }
    if (Prograd_1[j] == 'e' || Prograd_1 == 'E') {
        e++;
    }
    if (Prograd_1[j] == 'i' || Prograd_1 == 'I') {
        i++;
    }
    if (Prograd_1[j] == 'o' || Prograd_1 == 'O') {
        o++;
    }
    if (Prograd_1[j] == 'u' || Prograd_1 == 'U') {
        u++;
    }
}
}
else
{
    for (let j = 0; j < len2; j++) {
        if (Prograd_2[j] == 'a' || Prograd_2 == 'A') {
            a++;
        }
        if (Prograd_2[j] == 'e' || Prograd_2 == 'E') {
            e++;
        }
        if (Prograd_2[j] == 'i' || Prograd_2 == 'I') {
            i++;
        }
        if (Prograd_2[j] == 'o' || Prograd_2 == 'O') {
            o++;
        }
        if (Prograd_2[j] == 'u' || Prograd_2 == 'U') {
            u++;
        }
    }
}
...
document.write(`${Prograd_2}${Prograd_1}<br><br>`);
